...
SnowTooltip.TEMPLATE = ['<a class="ql-preview" rel="noopener noreferrer" target="_blank" href="about:blank">quilljs</a>', '<label for="ql-input-id">קישור:</lable>', '<input id="ql-input-id" type="text" data-formula="e=mc^2" data-link="https://quilljs.com" data-video="Embed URL">', '<a class="ql-action">ערוך</a>', '<a class="ql-remove">מחק</a>'].join('');
